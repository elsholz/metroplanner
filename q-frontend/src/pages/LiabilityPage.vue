  ...
  >
    <div class="column col col-lg-6 col-md-8 col-sm-12 text-body1 text-center">
      ...
      <div class="row text-white">
        <div class="col-12 q-py-sm text-justify">
          <div class="text-h6">
          Haftung für Inhalte Alle Inhalte
          </div>
          <p>
            unseres Internetauftritts wurden mit größter Sorgfalt und nach
      ...
      <div class="row text-white">
        <div class="col-12 q-py-sm text-justify">
          ...
          <p>
            ...
            unverzüglich entfernen. Dieses Impressum wurde freundlicherweise von
            jurarat.de zur Verfügung gestellt.
          </p>
        </div>
      </div>
    </div>
